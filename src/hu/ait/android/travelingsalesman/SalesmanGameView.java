...
public class SalesmanGameView extends View {
	...
	public void setHostActivity(GameActivity hostActivity) {
	...
	public SalesmanGameView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Set up view
	...
	public void newGame() {
		...
		if (nPoints == 10) {
			Toast.makeText(hostActivity, "YOU WIN! CONGRATS!", Toast.LENGTH_LONG);
		} else {
			...
			solve.execute(array);
			resetGame();
			hostActivity.setTimer(nPoints - 3);
			hostActivity.setText(nPoints - 3);
			invalidate();
		}
	}
	...
	public void displayAnswer() {
		...
		if (win)  {
			Toast.makeText(hostActivity, "Level Up!", Toast.LENGTH_SHORT).show();
			hostActivity.stopTimer();
			showAnswer = true;
			invalidate(); 
			nPoints++;
			newGame();
		} else {
			Toast.makeText(hostActivity, "GAME OVER", Toast.LENGTH_LONG).show();
			hostActivity.stopTimer();
			showAnswer = true;
			hostActivity.enableButton(false);
			invalidate(); 
		}
